...
class WeatherApp(QWidget):
    def __init__ (self):
        ...
        self.weekly_weather_label = QLabel(self)
        self.initUI()
    ...
    def initUI(self):
        ...
        self.weekly_weather_label.setObjectName("weekly_weather")
        self.setStyleSheet("""
            ...
            QLabel#weekly_weather{}
                        
                           """)
        self.getweather_button.clicked.connect(self.get_weather)

    def get_weather(self):
        api_key = "bcc2d3877535cf7bdbfa61944224ea4d"
    ...
    def display_weather(self,data):
        ...
        temperature_c = temperature_k - 23.15
